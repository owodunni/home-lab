---
description: Ansible Vault usage guide for this repo. Use when handling any secret, password, API token, or encryption key: creating/editing vault files, encrypting variables, referencing vault vars in group_vars, or when asked how to store sensitive data. All secrets must use vault_ prefix and be encrypted before committing.
---
